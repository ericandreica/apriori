...
class BaseClass {
    ...
    private double nrTr;
     ...
     public BaseClass(String file, double minsup, double minconf, boolean isReduced) {
        this.minsup = minsup;
    ...
    private void initItemSetReduced() {
    ...
    public Map<Set<String>, Integer> generateCand(int k) {
    ...
    public List<Set<String>> getSubsets(Set<String> myset) {
    ...
    public void calculateConfidence(int k) {
        //confidence
        for (int i = 2; i < k; i++) {
    ...
    public Map<String, Integer> getFkitmes() {
        return fkitmes;
    }

    public Map<Integer, Map<Set<String>, Integer>> getKitemset() {
        return kitemset;
    }
    ...
    public double getNrTr() {
        return nrTr;
    }

    public void setTransactions(List<Set<String>> transactions) {
        this.transactions = transactions;
    }

    public void setFkitmes(Map<String, Integer> fkitmes) {
        this.fkitmes = fkitmes;
    }

    public void setKitemset(Map<Integer, Map<Set<String>, Integer>> kitemset) {
    ...
    public void setNrTr(double nrTr) {
        this.nrTr = nrTr;
    }
}
